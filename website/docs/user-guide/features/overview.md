...
- **[Copilot Remote Jobs](copilot-jobs.md)** — Launch GitHub Copilot remote sessions, auto-route prompts to repositories, and reconnect later with tracked job metadata.

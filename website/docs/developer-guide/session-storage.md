...
| 25 | De-duplicate per-session system prompt snapshots into a shared content-addressed table; old column kept as a read fallback for partially migrated rows |

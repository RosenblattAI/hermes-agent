...
COPILOT_REMOTE_SCHEMA = {
    ...
    "description": (
        ...
        "Hermes' opt-in execution tool for explicit code-writing, file-editing, "
        "website-building, docs-writing, scripting, refactoring, testing, PR, "
        "build, and repository change requests. Use this only when the user "
        "explicitly asks Hermes to perform repository work or to hand that "
        "execution off to Copilot. Do not use this for discussion-only requests "
        "that ask Hermes to explain, compare, plan, review an idea, or answer "
        "when/should questions about implementation; answer those directly. "
        "This launches the existing detached "

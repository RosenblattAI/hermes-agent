...
#   - version: low-frequency info command; the upstream 2026-07-21 sync (plus
#     later upstream additions) added enough new canonical commands to hit
#     the 50-slot cap and clamp it off the native registry — reached via
#     /hermes version on Slack instead.

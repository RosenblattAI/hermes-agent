...
_BUILTIN_SUBCOMMANDS = frozenset(
    {
        ...
        "computer-use",
        "config", "console", "copilot", "cron", "curator", "dashboard", "serve", "debug", "doctor",
...
# === ROSENBLATT PATCH START: copilot remote session lifecycle command ===
# Reason: Rosenblatt-specific Copilot remote session management
